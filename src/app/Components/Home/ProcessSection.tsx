...
// Orchestrates child animations together smoothly
...
export default function ProcessSection() {
  return (
    <section className="w-full px-6 pb-12 text-neutral-950 overflow-hidden">
      {/* 1. Added master motion.div wrapper to coordinate entrance animations */}
      <motion.div 
      ...
      >
        ...
        <div className="text-center mb-20 md:mb-36">
          ...
          >
            ...
            <span className="font-serif text-lg italic tracking-wide">Our Process</span>
            <span className="h-px w-10 bg-neutral-400/40" />
          </motion.div>
